...
for run4 in ['train', 'test']:
    ...
    #for sift_hog_lbp_d in ['p32b4_d32p8_r4_d32', 'p32b3_d32p16_r3_d32', 'p32b2_d32p32_r2_d32', 'p64b4_d64p16_r4_d64', 'p64b3_d64p32_r3_d64', 'p64b2_d64p64_r2_d64', 'p128b4_d128p32_r4_d128', 'p128b3_d128p64_r3_d128', 'p128b2_d128p128_r2_d128']:
    for sift_hog_lbp_d in ['p64b3_d64p32_r3_d64']:
        ...
        for line_sift, line_hog, line_lbp, line_glcm in zip(lines_cat_sift, lines_cat_hog, lines_cat_lbp, lines_cat_glcm):
            ...
            if b_writeheader:
                ...
                str_temp = 'Total Features ' + str((n_tokens_sift + n_tokens_hog + n_tokens_lbp + n_tokens_glcm -4)*total_segs) + '\tTotal Patches are ' + str(total_segs) + ' and each patch has SIFT ' + str(n_tokens_sift-1) + ', HOG ' + str(n_tokens_hog-1) + ', LBP ' + str(n_tokens_lbp-1) +', and GLCM ' + str(n_tokens_glcm-1) + 'features\t' + 'class {0,1}' + '\t' +  'Image Path\n'
            ...
            if curr_seg == total_segs:
                #Verify the image
                assert((line_split_sift[n_tokens_sift-1] == line_split_hog[n_tokens_hog-1]) and (line_split_sift[n_tokens_sift-1] == line_split_lbp[n_tokens_lbp-1]) and (line_split_sift[n_tokens_sift-1] == line_split_glcm[n_tokens_glcm-1]))
                #append the class
                list_temp.append(0)
